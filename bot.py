        ...
        try:
            ...
            for i, row in enumerate(res, 1):
                content += (
                    ...
                    "=====================\n\n"
                    f"Name        : {row.get('name')}\n"
                    f"Father Name : {row.get('father_name') or 'Not Available'}\n"
                    f"Mobile      : {row.get('mobile')}\n"
                    f"Alt Mobile  : {row.get('alternative_mobile') or 'Not Available'}\n"
                    f"Circle/SIM  : {row.get('circle/sim')}\n"
                    f"Address     : {parse_address(row.get('address'))}\n"
                    f"Id Number   : {row.get('aadhar_number') or 'Not Available'}\n"
